...
export const Wrapper = tw.footer`container pointer-events-none absolute bottom-0 left-1/2 z-20 flex h-(--footer-height) min-h-16 -translate-x-1/2 justify-around lg:items-center`
