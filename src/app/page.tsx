  ...
  return (
    <div className='flex flex-1 flex-col items-center justify-center bg-zinc-50 font-sans dark:bg-black'>
      <main className='flex w-full max-w-3xl flex-1 flex-col items-center justify-between bg-white px-16 py-32 sm:items-start dark:bg-black'>
        <Image alt='Next.js logo' className='h-5 w-25 dark:invert' height={20} priority src='/next.svg' width={100} />
        ...
        <div className='flex flex-col gap-4 font-medium text-base sm:flex-row'>
          <a
            ...
            target='_blank'
          >
            <Image alt='Vercel logomark' className='h-3.5 w-4 dark:invert' height={14} src='/vercel.svg' width={16} />
            Deploy Now
          </a>
          <a
